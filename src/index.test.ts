...
describe('Number to English converter test suite', () => {
    ...
    it('should print correctly for -99999', () => {
        expect(convertNumberToEnglishText(-99999)).toBe('negative ninety nine thousand nine hundred ninety nine');
    });

    it('should print correctly for -0', () => {
        expect(convertNumberToEnglishText(-0)).toBe('zero');
    });

    it('should print correctly for -1', () => {
        expect(convertNumberToEnglishText(-1)).toBe('negative one');
    });

    it('should print correctly for -111', () => {
        expect(convertNumberToEnglishText(-111)).toBe('negative one hundred eleven');
    });
